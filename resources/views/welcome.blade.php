            ...
            <div class="col-xl-12 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg " style="margin-top: 100px">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6  "> <img src="/images/logo1.avif" alt="Logo"  style="width: 580px;height:425px;"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"> Car Management</h1>
                                    </div>
